...
class InputValidator:
    ...
    def validate_positive_number(
        value: float, min_value: float = 0.0, max_value: Optional[float] = None
    ) -> float:
        """
    ...
    def validate_decimal(
        value: str, max_digits: int = 18, decimal_places: int = 2
    ) -> Decimal:
        """
    ...
    def validate_alphanumeric(
        value: str, min_length: int = 1, max_length: int = 255
    ) -> str:
        """
