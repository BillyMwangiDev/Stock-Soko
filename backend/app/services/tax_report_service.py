...
from ..database.models import User, Order, Holding
...
class TaxReportService:
    ...
    def generate_csv_report(
        ...
        try:
            ...
            writer.writerow(["Short-term Capital Gains", f"{gains_data['short_term_gain']:.2f} KES"])
            writer.writerow(["Long-term Capital Gains", f"{gains_data['long_term_gain']:.2f} KES"])
            writer.writerow(["Total Capital Gains", f"{gains_data['total_gain']:.2f} KES"])
