...
class AchievementService:
        ...
        try:
            ...
            return {
                ...
                "progress": {
                    ...
                    "percent": round((len(earned) / len(ACHIEVEMENTS)) * 100, 1) if ACHIEVEMENTS else 0
                }
            }
    ...
    def get_progress(user_id: str, db: Session) -> Dict[str, Any]:
        ...
        """
        try:
            earned_ids = [a["achievement_id"] for a in AchievementService._user_achievements[user_id]]
            ...
            for achievement_id, achievement in ACHIEVEMENTS.items():
                ...
                if achievement_id == "portfolio_builder":
                    ...
                    current = float(portfolio.total_value) if portfolio and portfolio.total_value else 0
                    target = 15000
