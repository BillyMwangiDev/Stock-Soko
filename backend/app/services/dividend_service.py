...
class DividendService:
    ...
    @staticmethod
    def calculate_portfolio_dividends(user_id: str, db: Session) -> Dict[str, Any]:
        """
    ...
    def get_upcoming_dividends(
        user_id: str, db: Session, days_ahead: int = 90
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if not holdings:
                return {"success": True, "upcoming": [], "message": "No holdings found"}
            ...
            for holding in holdings:
                ...
                if dividend_data:
                    payment_date = datetime.strptime(
                        dividend_data["next_payment_date"], "%Y-%m-%d"
                    ).date()
    ...
    def get_dividend_history(
        user_id: str, db: Session, symbol: Optional[str] = None, limit: int = 50
    ) -> Dict[str, Any]:
        """
