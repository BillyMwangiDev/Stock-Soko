...
class LeaderboardService:
    ...
    def calculate_user_stats(user_id: str, db: Session) -> Dict[str, Any]:
        ...
        try:
            ...
            return_percent = (
                (return_amount / starting_balance) * 100 if starting_balance > 0 else 0
            )
            ...
            winning_trades = sum(
                ...
                if o.side == "sell" and float(o.filled_price) > float(o.price)
            )
    ...
    def get_global_leaderboard(
        db: Session, period: str = "all_time", limit: int = 100
    ) -> Dict[str, Any]:
        """
    ...
    def get_user_rank(user_id: str, db: Session) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "total_participants": len(leaderboard),
                "percentile": (
                    round((1 - (user_rank / len(leaderboard))) * 100, 1)
    ...
    def get_top_performers(
        db: Session, metric: str = "return_percent", limit: int = 10
    ) -> Dict[str, Any]:
        """
