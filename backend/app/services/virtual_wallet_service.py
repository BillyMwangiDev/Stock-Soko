...
class VirtualWalletService:
    ...
    def create_wallet(user_id: str, db: Session) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Created virtual wallet for user {user_id} with ${VirtualWalletService.STARTING_BALANCE}")
    ...
    def deposit(
        ...
        amount: float,
        db: Session,
        description: str = "Virtual deposit"
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            portfolio.buying_power = Decimal(str(float(portfolio.buying_power) + amount))
