...
from ..database.models import User, Portfolio, Holding, Stock
...
class PortfolioService:
        ...
        try:
            ...
            for holding in holdings:
                ...
                try:
                    ...
                    logger.warning(f"Failed to get live price for {stock.symbol}, using cached: {e}")
                    current_price = float(stock.latest_price) if stock.latest_price else float(holding.avg_price)
            ...
            for item in holdings_data:
                item["allocation_pct"] = round((item["market_value"] / total_value * 100) if total_value > 0 else 0, 2)
            ...
            total_unrealized_pl_pct = (total_unrealized_pl / total_invested * 100) if total_invested > 0 else 0
    ...
    def calculate_unrealized_pl(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            for holding in holdings:
                ...
                unrealized_pl_pct = ((current_price - avg_price) / avg_price * 100) if avg_price > 0 else 0
    ...
    def calculate_performance(self, user_id: str, days: int = 30) -> Dict[str, Any]:
        ...
        try:
            ...
            sharpe_ratio = (avg_return - risk_free_rate_daily) / volatility if volatility > 0 else 0
