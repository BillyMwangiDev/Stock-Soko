...
BEGINNER_LESSONS = [
        ...
        "quiz": [
            {
                ...
                "options": ["Lending money to a company", "Owning part of a company", "Betting on price movement", "Donating to business"],
                "correct": 1
            }
        ]
    },
    {
        ...
        "formulas": [
            ...
            {"name": "Shareholders' Equity", "formula": "Total Assets - Total Liabilities"}
        ],
        "practical_examples": [
        ...
        "key_line_items": {
            "income_statement": ["Revenue (Sales)", "Gross Profit", "Operating Income (EBIT)", "Net Income", "EPS"],
            "balance_sheet": ["Current Assets", "Inventory", "PP&E", "Total Liabilities", "Shareholders' Equity"],
            "cash_flow": ["Cash from Operations (CFO)", "Capital Expenditures (CapEx)", "Free Cash Flow (FCF)"]
        }
    },
    {
        "id": "L1-003",
        ...
        "formulas": [
            ...
            {"name": "EPS", "formula": "EPS = (Net Income - Preferred Dividends) / Shares Outstanding"}
        ],
        "practical_examples": [
...
ADVANCED_LESSONS = [
    ...
    },
    {
        ...
        "sample_metrics": {
            "fundamentals": ["P/E percentile (inverted)", "Revenue growth 3yr", "ROE 3yr", "FCF margin"],
            "technicals": ["Price vs 50-day MA", "RSI (optimal 40-60)", "MACD signal", "OBV trend"],
...
LEARNING_PATHS = {
    "complete_beginner": {
        ...
        "duration_weeks": 8,
        "path": [
            {"week": 1, "lessons": ["L1-001", "L1-002"], "homework": "Open brokerage account, read 3 annual reports"},
            {"week": 2, "lessons": ["L1-003", "L1-004"], "homework": "Calculate P/E for 5 NSE stocks"},
            {"week": 3, "lessons": ["L2-001"], "homework": "Analyze ROE, ROA for 3 banks"},
            {"week": 4, "lessons": ["L2-002"], "homework": "Calculate FCF for 2 companies"},
            {"week": 5, "lessons": ["L2-003"], "homework": "Plot 50-day and 200-day MAs for SCOM"},
            {"week": 6, "lessons": ["L2-004"], "homework": "Calculate position size for 3 example trades"},
            {"week": 7, "lessons": ["L3-001"], "homework": "Build simple DCF model for one stock"},
            {"week": 8, "lessons": ["L3-002", "L3-003"], "homework": "Create a diversified 10-stock portfolio"}
        ]
    },
    "value_investing": {
        ...
        "path": [
            {"week": 1, "lessons": ["V1-001", "V1-002"], "homework": "Identify 5 NSE stocks trading below book value"},
            {"week": 2, "lessons": ["V1-003"], "homework": "Calculate margin of safety for 3 stocks"},
            {"week": 3, "lessons": ["V2-001", "V2-002"], "homework": "Analyze competitive advantages of 2 companies"},
            {"week": 4, "lessons": ["V2-003"], "homework": "Build intrinsic value model for 1 stock"},
            {"week": 5, "lessons": ["V2-004"], "homework": "Analyze liquidity and risk metrics"},
            {"week": 6, "lessons": ["V3-001"], "homework": "Compare ROE across banking sector"},
            {"week": 7, "lessons": ["V3-002"], "homework": "Sector analysis: cyclical vs defensive"},
            {"week": 8, "lessons": ["V3-003"], "homework": "10-year historical analysis of 1 company"},
            {"week": 9, "lessons": ["V3-004"], "homework": "Kenya market cycle analysis"},
            {"week": 10, "project": "Build value portfolio with 8-10 stocks, 3-5 year target"}
        ]
    },
    "fundamental_focused": {
        ...
        "path": [
            ...
            {"week": 5, "practice": "Analyze 20 NSE stocks, rank by composite fundamental score"},
            {"week": 6, "project": "Build DCF models for top 5 stocks, compare to market price"}
        ]
    },
    "technical_focused": {
