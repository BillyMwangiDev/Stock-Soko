...
NSE_POPULAR_STOCKS = [
    "NSE:SCOM", "NSE:EQTY", "NSE:KCB", "NSE:COOP", "NSE:BAT",
    "NSE:EABL", "NSE:ABSA", "NSE:SCBK", "NSE:DTBK", "NSE:NCBA"
]
...
def update_market_movers():
    ...
    try:
        ...
        logger.info(f"Updated market movers: {len(movers.get('gainers', []))} gainers, {len(movers.get('losers', []))} losers")
