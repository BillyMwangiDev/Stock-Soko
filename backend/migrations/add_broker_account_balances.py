...
from sqlalchemy import create_engine, Column, String, Numeric, Boolean, DateTime, ForeignKey, Index
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Database migration for broker account balances")
    parser.add_argument(
        "--rollback",
        action="store_true",
    ...
    if args.rollback:
        confirm = input("Are you sure you want to rollback? This may cause data loss. (yes/no): ")
